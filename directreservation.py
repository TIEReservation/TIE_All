...
# [Previous functions: load_property_room_map, generate_booking_id, check_duplicate_guest, calculate_days, safe_int, safe_float, load_reservations_from_supabase, save_reservation_to_supabase, update_reservation_in_supabase, delete_reservation_in_supabase, show_confirmation_dialog, group_by_month_and_week, display_filtered_analysis, show_reservations, show_edit_reservations, show_analytics remain unchanged]
...
# [Remaining code: main app logic, session state initialization, etc., remains unchanged]
